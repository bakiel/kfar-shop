...
// Simple COD Checkout (Task #4)
// Phase-1 brief: only Full Name, Address, Phone. Cash on Delivery only.
// Users land here when NEXT_PUBLIC_CHECKOUT_SIMPLE=true (see /checkout/page.tsx).
//
// Design language 1: warm / functional. Cream surface, forest-green CTA,
// amber accent on the trust strip. No impossible collage, no multi-step wizard.
