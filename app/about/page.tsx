...
const AboutPage = () => {
  ...
  // Helper function to check if content should be visible based on search
  const isContentVisible = (content: string) => {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              <input
                type="text"
                placeholder="Search in current section..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full px-12 py-4 border-2 border-gray-200 rounded-full text-lg focus:outline-none focus:border-green-500 transition-colors duration-300 bg-white shadow-lg"
                style={{ borderColor: searchQuery ? '#478c0b' : undefined }}
              />
              <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                <i className="fas fa-search text-xl" style={{ color: '#478c0b' }}></i>
              </div>
              {searchQuery && (
                <button
          ...
          <div className={`${activeTab === 'tourism' ? 'block' : 'hidden'} animate-fadeIn`}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {isContentVisible('Sacred Visitation Jerusalem Live Sea Jericho spiritual guidance') && (
              ...
              {isContentVisible('Vegan Cooking Workshop traditional AHIC recipes modern vegan techniques community chefs') && (
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-red-500">
              ...
              {isContentVisible('Organic Farm Experience community farmers sustainable agriculture practices organic greenhouses') && (
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-red-500">
