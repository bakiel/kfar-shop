        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              ...
              <Link href="/demo/customer-profiles" className="group">
                <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Complete customer system with QR codes, loyalty tiers, and Supabase integration
                  </p>
              ...
              <Link href="/demo/customer-onboarding" className="group">
                <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
                  <div className="text-4xl mb-4">🚀</div>
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-green-600 transition-colors">
                    Onboarding Flow
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Seamless registration with automatic QR generation and AI avatar analysis
                  </p>
                  <span className="text-green-600 font-medium text-sm">
                    Try It Live →
                  </span>
              ...
              <Link href="/demo/ai-personalization" className="group">
                <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
                  <div className="text-4xl mb-4">🧠</div>
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-green-600 transition-colors">
                    AI Personalization
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Smart predictions and recommendations using QR scan data patterns
                  </p>
                  <span className="text-green-600 font-medium text-sm">
                    View Demo →
                  </span>
