...
import {
  LayoutDashboard, Store, Package, ShoppingCart, Users, Tag, Settings, Contact, Bell
} from 'lucide-react';
...
const adminMenuItems: MenuItem[] = [
  ...
  { id: 'notifications', path: '/admin/notifications', label: 'Notifications', labelHe: 'התראות', icon: <Bell className="w-5 h-5 stroke-[1.5]" /> },
