...
import { useTranslation, useBilingualForm } from '@/hooks/useTranslation';
...
export default function VendorOnboarding() {
  ...
  // Use bilingual form hook for automatic translation
  const {
    values: storeData,
    setValues: setStoreData,
    handleFieldChange: handleStoreFieldChange,
    autoTranslate,
    setAutoTranslate,
    isTranslating: isTranslatingStore
  } = useBilingualForm<StoreData>(initialStoreData, [
    { english: 'storeName', hebrew: 'storeNameHe', context: 'store_name' },
    { english: 'description', hebrew: 'descriptionHe', context: 'description' }
  ]);

  const [products, setProducts] = useState<Product[]>([]);
  const [bulkImportMode, setBulkImportMode] = useState(false);
  const [selectedProductForPricing, setSelectedProductForPricing] = useState<string | null>(null);
  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setAiMessage("🎉 Congratulations! Your store is now live on KFAR Marketplace! Redirecting to your vendor dashboard where you can generate QR codes and manage your store...");
        
        // Redirect to vendor dashboard after delay
        setTimeout(() => {
          router.push(`/vendor/dashboard?vendorId=${result.vendorId}&storeName=${encodeURIComponent(storeData.storeName)}&newVendor=true`);
        }, 3000);
      } else {
                ...
                <div className="mb-6 p-4 rounded-lg kfar-bg-herbal-mint/20 border border-leaf-green/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <p className="text-body-sm font-semibold">Auto-Translation</p>
                          <TranslationBadge active={autoTranslate} compact />
                        </div>
                        <p className="text-caption kfar-text-gray-600">
                          {autoTranslate ? 'Type in any language and we\'ll translate automatically' : 'Translation disabled - enter both languages manually'}
                        </p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-leaf-green/20 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-leaf-green"></div>
                    </label>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="input"
                      />
                      <TranslationIndicator isTranslating={isTranslatingStore} />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => handleStoreFieldChange('storeNameHe', e.target.value)}
                        placeholder="שם החנות בעברית"
                        className="input text-right"
                        dir="rtl"
                      />
                      <TranslationIndicator isTranslating={isTranslatingStore} position="left" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className="input"
                      />
                      <TranslationIndicator isTranslating={isTranslatingStore} top="top-3" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        onChange={(e) => handleStoreFieldChange('descriptionHe', e.target.value)}
                        placeholder="תיאור קצר בעברית..."
                        rows={3}
                        className="input text-right"
                        dir="rtl"
                      />
                      <TranslationIndicator isTranslating={isTranslatingStore} position="left" top="top-3" />
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    {products.length === 0 ? (
                      ...
                      products.map((product) => (
                        <div key={product.id} className={`border-2 rounded-lg p-6 transition-all relative ${
                            ...
                            <div className="md:col-span-3 grid md:grid-cols-2 gap-4">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  dir="rtl"
                                />
                                <TranslationIndicator isTranslating={isTranslating} position="left" />
                              </div>
                              <div className="md:col-span-2">
                                <textarea
                              ...
                              <div>
                                <div className="flex gap-2 items-center">
                                  ...
                                  {product.category && (
                                    <button
                                      onClick={() => setSelectedProductForPricing(
                                        selectedProductForPricing === product.id ? null : product.id
                                      )}
                                      className={`px-3 py-2 rounded-lg transition-all ${
                                        selectedProductForPricing === product.id
                                          ? 'bg-leaf-green text-white'
                                          : 'bg-gray-100 hover:bg-gray-200 text-gray-700'
                                      }`}
                                      title="Get pricing suggestions"
                                    >
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <option value="prepared-foods">Main Dishes</option>
                                  <option value="desserts">Desserts</option>
                                  <option value="beverages">Beverages</option>
                                  <option value="snacks">Snacks</option>
                                  <option value="spreads">Spreads & Dips</option>
                          ...
                          {selectedProductForPricing === product.id && product.category && (
