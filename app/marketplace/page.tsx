      ...
      if (response.ok) {
        ...
        if (data.success && data.products) {
          ...
          const formattedProducts = data.products.map((product: any) => ({
            ...
            originalPrice: (product.originalPrice ?? product.original_price) ? parseFloat(product.originalPrice ?? product.original_price) : undefined,
            category: product.category || 'other',
            image: product.image || product.image_url || product.primary_image || '/images/placeholder-product.jpg',
            images: product.images || product.image_gallery || [],
            kashrut: (product.kashrut || product.is_kosher) ? 'כשר' : undefined,
            vegan: product.vegan ?? product.is_vegan ?? false,
            organic: product.organic ?? product.is_organic ?? false,
            glutenFree: product.glutenFree ?? product.is_gluten_free ?? false,
            ...
            vendorName: product.vendorName || product.vendor_name || product.vendor?.name || getVendorDisplayName(product.vendorId || product.vendor_id),
