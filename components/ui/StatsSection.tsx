...
const StatsSection = () => {
  ...
  const primaryStats: Stat[] = [
    ...
    },
    {
      ...
      sublabel: t('Always Here for You'),
      icon: 'fa-headset',
      color: '#478c0b',
      background: 'linear-gradient(135deg, #478c0b, #3a7209)'
    }
  ...
  const businessHighlights = [
    { icon: 'fa-truck', value: t('Same Day'), label: t('Fast Delivery'), business: t('Local Orders Before 2PM') },
    { icon: 'fa-shield-alt', value: '100%', label: t('Secure Payment'), business: t('SSL Encrypted Checkout') },
    { icon: 'fa-handshake', value: '30+', label: t('Trusted Vendors'), business: t('Quality Verified Partners') },
    { icon: 'fa-mobile-alt', value: t('Voice'), label: t('Shopping Available'), business: t('Order Hands-Free') }
  ];

  const milestones = [
    { year: '1973', event: t('First Store Opens'), detail: t('Community marketplace begins') },
    { year: '1983', event: t('Manufacturing Starts'), detail: t('Teva Deli plant-based foods') },
    { year: '2020', event: t('Online Expansion'), detail: t('Digital marketplace launches') },
    { year: '2024', event: t('Voice Commerce'), detail: t('AI-powered shopping arrives') }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#4b5563' }}>
            {t('Your one-stop marketplace for authentic products, fast delivery, and exceptional customer service powered by cutting-edge technology.')}
          </p>
        </div>
