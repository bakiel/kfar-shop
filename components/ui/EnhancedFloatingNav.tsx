  ...
  return (
    <div className={`fixed right-6 top-1/2 -translate-y-1/2 z-50 transition-all duration-500 ${
      ...
      >
        ...
        <svg className="absolute inset-0 w-32 h-32 -m-2 transform -rotate-90">
          <circle
            cx="64"
            cy="64"
            r="62"
          ...
          <circle
            ...
            strokeDashoffset={`${2 * Math.PI * 62 * (1 - scrollProgress / 100)}`}
        ...
        {/* Main Button */}
        <button className="relative w-28 h-28 bg-white rounded-full shadow-2xl border-4 border-sun-gold overflow-hidden group">
          <Image
        ...
        <div className="absolute -left-24 top-0 space-y-3">
          {/* Cart Button */}
          <Link href="/cart">
        ...
        {/* Welcome Message */}
        <div className={`absolute right-32 top-1/2 -translate-y-1/2 transition-all duration-500 ${
