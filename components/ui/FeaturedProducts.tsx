  ...
  return (
    <section className="py-12 md:py-20 relative overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* Category Filter Pills - Mobile Optimized */}
        <div className="flex overflow-x-auto pb-2 mb-12 -mx-4 px-4 md:flex-wrap md:justify-center md:gap-4 gap-3 scrollbar-hide">
