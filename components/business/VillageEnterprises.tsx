  ...
  const enterprises: Enterprise[] = [
    {
      ...
      tagline: t('The Original Vegan Factory'),
      category: t('Plant-Based Manufacturing'),
      yearFounded: '1983',
      specialty: t('Seitan & Tofu Products'),
      featured: [
        {
      ...
      description: t('Pioneering vegan food manufacturing since 1983, bringing plant-based alternatives to Israeli tables nationwide.'),
      color: '#478c0b'
    },
    {
      id: 'queens-cuisine',
      ...
      tagline: t('Art of Vegan Catering'),
      category: t('Gourmet Catering & Events'),
      yearFounded: '1995',
      specialty: t('Premium Event Catering'),
      featured: [
        {
      ...
      description: t('Elevating plant-based cuisine to an art form for celebrations, events, and special occasions.'),
      color: '#f6af0d'
    },
    {
      id: 'garden-of-light',
      ...
      tagline: t('Premium Vegan Delicacies'),
      category: t('Artisan Chocolates & Spreads'),
      yearFounded: '2008',
      specialty: t('Handcrafted Confections'),
      featured: [
        {
      ...
      description: t('Family-made premium vegan chocolates and spreads, continuing Edenic traditions with modern flair.'),
      color: '#c23c09'
    },
    {
      id: 'gahn-delight',
      ...
      tagline: t('Artisanal Ice Cream Dreams'),
      category: t('Frozen Desserts'),
      yearFounded: '2012',
      specialty: t('Exotic Vegan Ice Cream'),
      featured: [
        {
      ...
      description: t('Handcrafted vegan ice cream with exotic Middle Eastern flavors and premium ingredients.'),
      color: '#478c0b'
    },
    {
      id: 'people-store',
      ...
      tagline: t('Your Community Market'),
      category: t('International Foods & Bulk'),
      yearFounded: '1998',
      specialty: t('Specialty Imports'),
      featured: [
        {
      ...
      description: t('Your source for specialty foods, bulk ingredients, and hard-to-find international products.'),
      color: '#f6af0d'
    },
    {
      id: 'vop-shop',
      ...
      tagline: t('Heritage & Wellness Hub'),
      category: t('Community Products'),
      yearFounded: '2005',
      specialty: t('Cultural & Wellness Items'),
      featured: [
        {
      ...
      description: t('Celebrating our heritage with cultural products, wellness resources, and community pride.'),
      color: '#c23c09'
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6" style={{ color: '#3a3a1d' }}>
            {t('Village Enterprises')}
          </h2>
          <p className="text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#4b5563' }}>
            {t('These pioneering businesses established the foundation of Village of Peace commerce, each carrying decades of heritage and community values into the future.')}
          </p>
        </div>
