...
import { Calendar, Award, Package, Star, Heart, Mail } from 'lucide-react';
        ...
        <div className="flex-1">
          ...
          {established && (
            <p className="text-gray-600 mb-4">
              <Calendar className="w-4 h-4 stroke-[1.5] inline mr-2" style={{ color: '#478c0b' }} />
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t">
        <div className="text-center">
          <div className="text-2xl font-bold" style={{ color: '#478c0b' }}>
            <Package className="w-5 h-5 stroke-[1.5] inline mr-2" />
            48
          </div>
        ...
        <div className="text-center">
          <div className="text-2xl font-bold" style={{ color: '#f6af0d' }}>
            <Star className="w-5 h-5 stroke-[1.5] inline mr-2" />
            4.8
          </div>
        ...
        <div className="text-center">
          <div className="text-2xl font-bold" style={{ color: '#c23c09' }}>
            <Heart className="w-5 h-5 stroke-[1.5] inline mr-2" />
            1.2k
          </div>
